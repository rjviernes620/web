    ...
    <footer className="bg-[#0a0b10] border-t border-white/5 py-8 md:py-12">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-sm text-gray-500 font-mono text-center md:text-left">
          Copyright © {currentYear} Roel-Junior Alejo Viernes, Developed by <a href="https://github.com/rjviernes620" className="text-[#61DAFB] hover:text-[#20232A]">Roel-Junior Alejo Viernes</a>
        </p>
